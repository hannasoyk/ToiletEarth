...
$( document ).ready( function(){
	...
	window.earth = new THREE.Mesh(
		...
		new THREE.MeshLambertMaterial({ 
			map: THREE.ImageUtils.loadTexture( 'media/earthwowater.jpg' )
		})
	)
	...
	// 			blendSrc: THREE.DstColor,
	// 			blendDst: THREE.OneMinusDstAlpha,
...
function fetchTweets(){
	...
	$.ajax({
		...
		//url: 'http://search.twitter.com/search.json?geocode=0,0,6400km',
		  url: 'http://search.twitter.com/search.json?q=toilet%20OR%20toilets&geocode=0,0,6400km',
...
function addLights(){
	...
	ambient = new THREE.AmbientLight( 0x797979)
	scene.add( ambient )	
